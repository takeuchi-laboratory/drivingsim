...
public class TransformObject2 : MonoBehaviour
{
    ...
    private void OnGUI()
    {
        GUI.Label(new Rect(150, 180, 500, 100), "GreenCarSpeed" + CarSpeed.ToString());
        GUI.Label(new Rect(150, 200, 500, 100), "GreenCarCm" + Cm.ToString());
        GUI.Label(new Rect(150, 220, 500, 100), "GreenCarCo" + Co.ToString());
        ...
        else if(DrivingMode == 1)
        {
            ...
            if (pass_N == 0)
            {
                ...
                else
                {
                    ...
                    cartransform.Translate((40 / 3.6f + (f * 0.02f)) * 0.02f * Math.Abs(tx / t), 0, (40 / 3.6f + (f * 0.02f)) * 0.02f * Math.Abs(tz / t));
